...
def upgrade():
    ...
    op.add_column('users', sa.Column('hashed_password', sa.String(100), nullable=True))
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('users', sa.Column('password', sa.VARCHAR(100), autoincrement=False, nullable=True))
